...
description: Capa DOM que conecta descriptors de presentación con Web Components.
---

Primitives renderiza campos, informes, layout, errores y submit a partir de descriptores de presentación.
